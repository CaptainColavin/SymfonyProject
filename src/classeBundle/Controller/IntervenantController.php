...
use classeBundle\Entity\Intervenant;
...
class IntervenantController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $intervenants = $em->getRepository('classeBundle:Intervenant')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('classeBundle\Form\IntervenantType', $intervenant);
    ...
    {
        $deleteForm = $this->createDeleteForm($intervenant);
        $editForm = $this->createForm('classeBundle\Form\IntervenantType', $intervenant);
