...
class CoursController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $cours = $em->getRepository('classeBundle:Cours')->findAll();
    ...
    {
        $cour = new Cours();
        $form = $this->createForm('classeBundle\Form\CoursType', $cour);
    ...
    {
        $deleteForm = $this->createDeleteForm($cour);
        $editForm = $this->createForm('classeBundle\Form\CoursType', $cour);
